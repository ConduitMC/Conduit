...
abstract class PlayerMixin: Player {
    ...
    @Shadow
    private override var respawnPosition: BlockPos? = null
    ...
    @get:Shadow
    abstract override val scoreboard: Scoreboard?

    @get:Shadow
    abstract override val isCreative: Boolean
    ...
    abstract override var isSwimming: Boolean
        set(isSwimming) {
            super.isSwimming = isSwimming
        }

    @get:Shadow
    abstract override val armorSlots: Iterable<ItemStack?>?

    @get:Shadow
    abstract override val handSlots: Iterable<ItemStack?>?

    @Shadow
    abstract fun addItem(item: ItemStack?): Boolean

    @Shadow
    abstract fun setItemSlot(slot: EquipmentSlot?, item: ItemStack?)

    @get:Shadow
    abstract override val isHurt: Boolean
    ...
    @get:Shadow
    abstract override val foodData: FoodData?

    @Shadow
    abstract override fun causeFoodExhaustion(exhaustion: Float)

    @get:Shadow
    abstract override val xpNeededForNextLevel: Int
    ...
    @Shadow
    abstract fun isRespawnForced(): Boolean

    @Shadow
    abstract fun getRespawnPosition(): BlockPos?

    @get:Shadow
    abstract override val isSleepingLongEnough: Boolean
    ...
    @get:Shadow
    @set:Shadow
    abstract override var score: Int
    ...
    @Shadow
    abstract fun playSound(sound: SoundEvent?, volume: Float, pitch: Float)
