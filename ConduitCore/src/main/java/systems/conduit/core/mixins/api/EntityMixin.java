...
public abstract class EntityMixin implements systems.conduit.api.Entity {
    ...
    @Override
    public void teleport(systems.conduit.api.Entity entity) {
    ...
    public List<systems.conduit.api.Entity> conduit_getPassengers() {
        return this.shadow$getPassengers().stream().map(systems.conduit.api.Entity.class::cast).collect(Collectors.toList());
    }

    public Optional<systems.conduit.api.Entity> conduit_getControllingPassenger() {
        Entity entity = this.shadow$getControllingPassenger();
        if (entity == null) return Optional.empty();
        return Optional.of((systems.conduit.api.Entity) entity);
    }
}
