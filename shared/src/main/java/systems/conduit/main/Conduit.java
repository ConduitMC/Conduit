...
public class Conduit {
    ...
    @Getter private static LevelManager levelManager;
    ...
    /**
     * This is an internal function, and should not be called by any other plugins or mixins.
     */
    public static void initializeVersion(LevelManager manager) {
        if (levelManager == null) Conduit.levelManager = manager;
    }
}
